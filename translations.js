...
(function () {
  const I18N = {
    ...
    'ai.card0.p': 'अकादमिक समीक्षकों की प्रतिक्रिया को संशोधन के एक संरचित, खेल-रूपी रोडमैप में बदलें। यह समीक्षकों की टिप्पणियों का विश्लेषण करता है, उन्हें विषय व महत्ता के अनुसार व्यवस्थित करता है, और XP पुरस्कारों के साथ प्राथमिकता-क्रम में दैनिक कार्य बनाता है। प्रगति-पट्टियाँ बड़े व छोटे संशोधनों में आपकी राह दर्शाती हैं — कोई खाता नहीं, कोई डेटा-संग्रह नहीं, सब कुछ स्थानीय रूप से सुरक्षित।',
    ...
    'foot.cv':            'सीवी (PDF) ↓',
    'foot.nav.gallery':   'फ़ील्डवर्क चित्रशाला',
    'foot.nav.ai':        'AI के साथ प्रयोग',
    'foot.nav.play':      'खेल',
